import React, { useState, useEffect } from 'react'; // before --- import React, { useState } from 'react'
...
const DepartmentList = () => {
  const [departments, setDepartments] = useState([]); // setDepartment+s added.........................................
          ...
          const data = await responnse.data.departments.map((dep) => (
            {
              ...
              action: (<DepartmentButtons Id={dep._id} onDepertmentDelete={onDepertmentDelete}/>)
            }
          ))
          setDepartments(data)  // s added '''''''''''''''''''''''''''''''''

    ...
    <div className='p-6'>
      ...
      <div className='mt-12'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mt-6'>
          <SummaryCard icon={<FaFileAlt />} text="Leave Appiled" number={summary.leaveSummary.appliedFor} color="bg-teal-600" />
          <SummaryCard icon={<FaCheckCircle />} text="Leave Aproved" number={summary.leaveSummary.approved} color="bg-green-600" />
